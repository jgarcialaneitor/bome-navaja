...
- [x] 5. Follow-up of task 4 (user request): find an AX article that sits in an extraordinary
      ...
      Fix: gap bulletins between the listed neighbours are read as pages first (200s, budget 4),
